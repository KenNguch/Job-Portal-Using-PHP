        ...
        <div class="formint">
          ...
          <div class="input-group <?php echo (form_error('company_logo'))?'has-error':'';?>">
            ...
            <div class="input-group">
              <label class="input-group-addon">Please enter: <?php echo $cpt_code;?>  in the text box below:</label></div>
