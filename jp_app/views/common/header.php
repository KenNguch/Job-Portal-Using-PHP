  ...
  <div class="navbar navbar-default" role="navigation">
        <div class="col-md-2">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url();?>" title="Kenya jobs website"><img src="<?php echo base_url('public/images/logo.png');?>" alt="Kenya jobs website" /></a> </div>
        </div>
        <div class="col-md-<?php echo ($this->session->userdata('is_user_login')==TRUE)?'6':'6';?>">
          <div class="navbar-collapse collapse">
			...
			?>
              ...
              <?php else:?>
              <li <?php echo active_link('');?>><a href="<?php echo base_url();?>"><i class="fa fa-home" aria-hidden="true"></i></a></li>
              <li <?php echo active_link('search-jobs');?>><a href="<?php echo base_url('search-jobs');?>" title="Search Government jobs in Kenya">Search a Job</a> </li>
              <li <?php echo active_link('search-resume');?>><a href="<?php echo base_url('search-resume');?>" title="Search Resume">Search Resume</a></li>
              <li <?php echo active_link('about-us.html');?>><a href="<?php echo base_url('about-us.html');?>" title="Kenya jobs free website">About Us</a></li>
              <li <?php echo active_link('contact-us');?>><a href="<?php echo base_url('contact-us');?>" title="Contact Us">Contact Us</a></li>
              <?php endif;?>
            </ul>
          </div>
